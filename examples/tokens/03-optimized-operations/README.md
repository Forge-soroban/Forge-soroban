...
Found an optimization we missed? [Submit an issue](https://github.com/Forge-soroban/Forge-soroban/issues) or [open a PR](https://github.com/Forge-soroban/Forge-soroban/pulls)!
